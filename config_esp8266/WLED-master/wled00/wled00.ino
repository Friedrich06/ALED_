...
char clientSSID[33] = "web";
char clientPass[65] = "wled1234";
char cmDNS[33] = "aled";                         //mDNS address (placeholder, will be replaced by wledXXXXXXXXXXXX.local)
...
//LED CONFIG
uint16_t ledCount = 120;                       //overcurrent prevented by ABL             
